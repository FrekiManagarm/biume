...
export function HeroSection() {
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent"></div>
      ...
      <div className="container relative mx-auto px-4 py-20">
        ...
        >
          ...
          <motion.div
            ...
            className="h-1 bg-linear-to-r from-transparent via-primary/50 to-transparent mt-12 max-w-md mx-auto"
          ></motion.div>
        </motion.div>
      </div>
    </section>
