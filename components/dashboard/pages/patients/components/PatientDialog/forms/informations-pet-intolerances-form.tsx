...
import { updatePetIntolerences } from "@/lib/api/actions/patients.action";
...
const InformationsPetIntolerancesForm = ({
  ...
  const { mutateAsync } = useMutation({
    mutationFn: (intolerences: string[]) =>
      updatePetIntolerences(intolerences, petId as string),
    onSuccess: () => {
  ...
  const handleSubmit = async () => {
    ...
    await mutateAsync(selectedIntolerances);
  };
